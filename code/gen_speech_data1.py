...
def process_pendigits_arff(arff_file='', output_dir='.'):
    """
    处理 pendigits.arff 文件，提取特征和标签，标准化，保存为 .npy 文件。
    ...
    print(f"✅ 已保存: {os.path.join(output_dir, 'speech.npy')}")
    print(f"✅ 已保存: {os.path.join(output_dir, 'speech_y.npy')}")
    print("=" * 50)
